...
<Card variant="flip" title="Flip Card">
  ...
  const sampleImage = 'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80';
</script>
  ...
  <div class="max-w-4xl mx-auto">
    ...
    >
      <div class="w-full max-w-sm">
        ...
        >
          <p>This is a basic card with title and subtitle. Cards are used to group related content and actions.</p>
        </Card>
      </div>
    </ComponentPreview>
