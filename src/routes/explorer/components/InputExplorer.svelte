  ...
  <ComponentPreview title="Input States">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="space-y-2">
        ...
        <Input
          bind:value={formData.withError}
          {...exampleProps.withError}
        />
      </div>
      ...
      <div class="space-y-2">
        ...
        <Input
          bind:value={formData.withSuccess}
          {...exampleProps.withSuccess}
        />
      </div>
      ...
      <div class="space-y-2">
        ...
        <Input
          bind:value={formData.withIcon}
          {...exampleProps.withIcon}
        />
      </div>
      ...
      <div class="space-y-2">
        ...
        <Input
          bind:value={formData.withHelper}
          {...exampleProps.withHelper}
        />
      </div>
